...
class PingTraceroute:
    ...
    def verbose_ping(self, timeout=2, max_ttl=30, counts=4):
        ...
        for ttl in range(1, max_ttl):
            ...
            for counter in range(1, counts):
                try:
                    delay, addr, is_final, reached = self.prepare_ping(self.dest_addr, timeout, ttl)
...
if __name__ == '__main__':
    pt = PingTraceroute("google.com.br")
    pt.verbose_ping()
