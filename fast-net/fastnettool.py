...
parser.add_argument("-t", "--traceroute", action="store_true", dest="traceroute", default=False, help="Execute traceroute")
parser.add_argument("-T", "--max_ttl", dest="max_ttl", type=int, default=30, help="Max TTL count")
